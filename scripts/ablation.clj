...
;; Three conditions on k=2 copy, all else equal:
...
;; Run:  clojure -M scripts/ablation.clj
(require '[mythjure.model :as model]
         '[mythjure.train :as train]
         '[mythjure.copytask :as copy]
         '[clojure.pprint :as pp])

(def K 2) (def SEQ 10) (def NC 14) (def T 8)
(def STEPS 250) (def BATCH 6) (def LR 1e-3)
...
(spit "scripts/ablation.edn" (with-out-str (pp/pprint results)))
(System/exit 0)
